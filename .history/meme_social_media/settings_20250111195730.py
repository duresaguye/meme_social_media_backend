"""
Django settings for meme_social_media project.
...
SECRET_KEY = 'django-insecure-fv(fw44*6n&2cg+d83mu2iz1)eq9+=t_v%sccw(ip*e6nb5#qe'
...
ROOT_URLCONF = 'meme_social_media.urls'
...
WSGI_APPLICATION = 'meme_social_media.wsgi.application'
...
# File system location for uploaded files
